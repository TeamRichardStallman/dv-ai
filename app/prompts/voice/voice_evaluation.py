    ...
    **If the answer is completely off-topic:**
    ...
    {{{{
        ...
        "answer": {{{{
            ...
            "scores": {{{{
                "text_scores": {{{{
                    "teamwork": {{{{ "score": 0, "rationale": "답변이 질문과 무관합니다." }}}},
                    "communication": {{{{ "score": 0, "rationale": "답변이 질문과 무관합니다." }}}},
                    "problem_solving": {{{{ "score": 0, "rationale": "답변이 질문과 무관합니다." }}}},
                    "accountability": {{{{ "score": 0, "rationale": "답변이 질문과 무관합니다." }}}},
                    "growth_mindset": {{{{ "score": 0, "rationale": "답변이 질문과 무관합니다." }}}}
                }}}},
                "voice_scores": {{{{
                    "wpm": {{{{ "score": 0, "rationale": "답변이 질문과 무관하여 평가를 진행하지 않습니다." }}}},
                    "stutter": {{{{ "score": 0, "rationale": "답변이 질문과 무관하여 평가를 진행하지 않습니다." }}}},
